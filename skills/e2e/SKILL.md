---
name: e2e
description: Plan, run, and diagnose end-to-end verification for websites, desktop GUI apps, and userscript/browser-extension flows. Use to choose the smallest realistic user path, reproduce reported UI behavior, protect user-owned browser state, gather acceptance evidence, and verify the exact affected path. Use e2e-harness for project-owned setup, browser/runtime lifecycle, profiles, shells, Playwright infrastructure, or other harness mechanics.
version: 2.0.0
---
...
If the required path has no working project harness, switch to `e2e-harness` to install or
...
`e2e-harness` owns reusable infrastructure and operational mechanics, including:
